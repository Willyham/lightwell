...
- **The f64 colour reference** (`exposure-cases.json`, and the `reference` module under
  `crates/luxforge-core/tests/reference/`): exact to the stated formula (standard sRGB transfer
...
`crates/luxforge-core/tests/basic_reference.rs` loads this file and asserts the Rust
