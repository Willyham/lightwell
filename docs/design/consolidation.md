...
Status: **authorized by the owner on 2026-09-24; wave 1 in progress.** The work is tracked in the [task plan](../../tasks/consolidation.json). When the last wave lands, delete this document and the plan; the outcome lives in the specs they changed.
