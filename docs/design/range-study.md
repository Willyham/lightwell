...
reference](../../crates/luxforge-core/tests/reference/range.rs) and its
[proofs](../../crates/luxforge-core/tests/range_reference.rs) are the complete specification the
...
reference **bit for bit** by `crates/luxforge-core/tests/mask_range.rs`.
...
| [`crates/luxforge-core/tests/reference/range.rs`](../../crates/luxforge-core/tests/reference/range.rs) | The frozen `f64` reference: the luminance axis, the band, the legality rules, the colour metric, the refine mapping and the multi-sample combination. Reuses `reference/tone.rs`'s luminance and OETF, `reference/colour.rs`'s Oklab and `reference/mask.rs`'s `smooth` unchanged. |
| [`crates/luxforge-core/tests/range_reference.rs`](../../crates/luxforge-core/tests/range_reference.rs) | The proofs and measurements above, the scenes chosen to fail, and the ignored figures test. |
| [`crates/luxforge-core/tests/reference/mod.rs`](../../crates/luxforge-core/tests/reference/mod.rs) | Declares `pub mod range;` beside the other studies' references. |
