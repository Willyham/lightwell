...
Status: numerical study (TASK-013 of [the Basic/histogram plan](../../tasks/implementation-basic-histogram.json)), frozen ahead of implementation. No production code exists yet for Temperature, Tint or the neutral picker; this document and its reference are what a later implementation task codes against, unguessed. See [Basic and histogram](basic-and-histogram.md) for the surrounding product and integration contract, and [product decisions](../decisions.md#basic-adjustments-and-histogram) for the picker default and rejection rules this document freezes.
