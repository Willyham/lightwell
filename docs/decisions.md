...
- Derived artifacts live in a directory beside the catalog and move with it; catalog format 8 holds their references beside the preset library, the mask table and the stroke store, and earlier formats are refused.
