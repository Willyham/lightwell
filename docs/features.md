...
| RAW camera profiles | Implemented | Validated embedded [JSON camera catalog](design/raw-camera-profiles.md) supplies native admission, recording modes, crop and DNG processing capabilities; the qualified camera/mode set is unchanged |
