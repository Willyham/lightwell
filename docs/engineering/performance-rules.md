...
| RAW temperature and tint drags redevelop the mosaic per input | Open | A matrix approximation on the developed planes during the gesture is a proposal in [instant previews](../design/instant-preview.md#proposals-and-later-work) |
