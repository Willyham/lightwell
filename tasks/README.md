...
| Plan | Purpose |
| --- | --- |
| [Performance second wave](performance-second-wave.json) | Exact source preparation, spatial estimate, DNG row, quantizer, clipping and RAW row optimizations with serial native qualification |
