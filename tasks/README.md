...
| Plan | Purpose |
| --- | --- |
| [Performance third wave](performance-third-wave.json) | Exact startup overlap, bounded native demosaic parallelism and measured RAW conversion with native qualification |
