...
pub(crate) struct Inputs<'a> {
    ...
    pub(crate) displayed_layers: Option<&'a [luxforge_core::Layer]>,
...
mod tests {
    ...
    impl Scene {
        ...
        fn displayed_layers(&self) -> Option<&[luxforge_core::Layer]> {
    ...
    fn the_idle_crop_section_reads_the_committed_crop_as_a_draft_would_seed_it() {
        ...
        let draft =
            CropDraft::from_layer(stage, wide, luxforge_core::LayerId::new(), 0, 3, &presets);
