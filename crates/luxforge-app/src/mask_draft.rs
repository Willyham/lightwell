...
pub(crate) const BRUSH: &str = luxforge_core::mask::BRUSH;
    ...
    pub(crate) fn method(&self) -> Option<&'static str> {
        match self.geometry {
            ...
            MaskGeometry::Shape(_) => {
                luxforge_core::mask::commands::geometry(self.op.geometry_op(), &self.kind)
...
mod tests {
    use super::*;
    use luxforge_core::{ParameterKind, mask::commands};
