...
impl<'a> MaskCanvas<'a> {
    ...
    fn draw_linear(&self, frame: &mut Frame, gradient: luxforge_core::mask::LinearGradient) {
    ...
    fn draw_radial(&self, frame: &mut Frame, radial: luxforge_core::mask::RadialGradient) {
    ...
    fn ellipse_path(
        &self,
        radial: luxforge_core::mask::RadialGradient,
        scale: f64,
        dashed: bool,
    ) -> Path {
        let aspect = self.draft.aspect();
