...
mod tests {
    use super::*;
    use crate::{
        ActionDescriptor, Availability, BoxRect, CROP_EFFECT, Component, ComponentMode,
        CropPayload, CropStage, EFFECT_FORMAT, EffectDescriptor, EffectStage, ExactGeometry, Layer,
        LayerId, Mask, ModuleDescriptor, ORIENTATION_EFFECT, Orientation, PIXEL_EFFECT,
        ParameterDescriptor, ParameterKind, PreviewQueue, Processing, Stage, ToolModule,
        open_source,
    };
    use serde_json::Map;
    use std::{
