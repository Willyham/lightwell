...
fn start_render(cancel: &Cancel) -> thread::JoinHandle<Result<lightwell_core::Raster, Error>> {
...
fn cancelled(outcome: Result<lightwell_core::Raster, Error>, elapsed: Duration, what: &str) {
