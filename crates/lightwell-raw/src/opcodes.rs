//! The DNG opcodes Lightwell implements: the one allowlist that decode, the camera catalog's
...
impl Opcode {
    /// The operation an entry of opcode list `list` with ID `id` is, when Lightwell implements
